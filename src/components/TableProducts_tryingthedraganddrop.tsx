...
//   const reorder = (columns: any, startIndex: any, endIndex: any) => {
...
//   const dataColumnsTable = [elementToAdd, ...columnsUserOrder];
  
//   const [columnsTable, setColumnsTable] = useState(dataColumnsTable)
...
// //     const items = Array.from(manageColumns);
// //     const [reorderData] = items.splice(result.source.index,1);
// //     items.splice(result.destination.index, 0, reorderData);
// //     setManageColumns(items)
// // }
// // const handleDragEnd = (result: any) => {
// //   if (!result.destination) return;
// //   const items = Array.from(columnsTable);
...
//   const columnsReordered = reorder(
//     columnsTable, // project is state 
//       result.source.index,
//       result.destination.index
//     );
//     //store reordered state.
//     setColumnsTable(columnsReordered)
//   }
...
//                     {/* <TableRow> */}
//                       {columnsTable.map((columnTable:any, index) => (
//                         <Draggable 
//                           // key={`column-${columnTable.id}`} 
//                           key={columnTable.id}
//                           draggableId={`column-${columnTable.id}`} 
//                           index={index}
//                         >
//                           {(provided) => (
...
//                             //   display: "inline-flex", // Change flex to inline-flex
//                             //   // display: "flex", // Ensure proper layout with draggable content
//                             // }}
//                             // >
//                             <TableCell
//                               {...provided.draggableProps}
...
//                               style={{ 
//                                 width: columnTable.width, 
//                                 // width: "100%", // Ensure the TableCell fills its container
