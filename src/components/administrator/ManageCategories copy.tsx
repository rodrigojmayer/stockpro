...
import { Data, DataCreateStockOptions, ColumnData, ProductEditData, CategoriesSubData } from '../../types';
...
import ManageCategoriesSubCategory from './ManageCategoriesSubCategory';
...
export default function ManageCategories( 
    ...
    const [ subCategoryUpdate, setSubCategoryUpdate ] = useState<CategoriesSubData>({
      ...
      const handleCloseManageCategoriesSubCategory = () => {
            ...
            >
                <Box sx={modalStyleExternal}>
                    ...
                    >
                        ...
                        />
                        <ManageCategoriesSubCategory
                            open={showUpdateSubCategoryUpdate}
                            handleClose={handleCloseManageCategoriesSubCategory}
