    ...
    function DanishTerms() {
        return (
            <>
                ...
                <ul>
                    <li>
                        <p><strong>At levere og vedligeholde vores tjeneste</strong>, herunder for at overvåge brugen af vores tjeneste.</p>
                    </li>
                    <li>
                        <p><strong>At administrere din konto:</strong> at administrere din registrering som bruger af tjenesten. De personlige data, du leverer, kan give dig adgang til forskellige funktionaliteter af tjenesten, der er tilgængelige for dig som registreret bruger.</p>
                    </li>
                    <li>
                        <p><strong>Til udførelse af en kontrakt:</strong> udviklingen, overholdelsen og indgåelsen af købsaftalen for de produkter, varer eller tjenester, du har købt eller af enhver anden kontrakt med os gennem tjenesten.</p>
                    </li>
                    <li>
                        <p><strong>At kontakte dig:</strong> at kontakte dig via email, telefonopkald, SMS eller andre tilsvarende former for elektronisk kommunikation, såsom push-meddelelser fra en mobilapplikation vedrørende opdateringer eller informative meddelelser relateret til funktionaliteter, produkter eller kontrakterede tjenester, herunder sikkerhedsopdateringer, når det er nødvendigt eller rimeligt for deres implementering.</p>
                    </li>
                    <li>
                        <p><strong>At give dig nyheder,</strong> specialtilbud og generelle oplysninger om andre varer, tjenester og begivenheder, som vi tilbyder, der ligner dem, du allerede har købt eller spurgt om, medmindre du har valgt ikke at modtage sådan information.</p>
                    </li>
                    <li>
                        <p><strong>At håndtere dine anmodninger:</strong> at deltage i og håndtere dine anmodninger til os.</p>
                    </li>
                    <li>
                        <p><strong>Til forretningsoverførsler:</strong> Vi kan bruge dine oplysninger til at evaluere eller gennemføre en fusion, afhændelse, omstrukturering, reorganisering, opløsning eller andet salg eller overførsel af nogle eller alle vores aktiver, hvad enten det er som en going concern eller som led i konkurs, likvidation eller lignende procedurer, hvor personlige data, der opbevares af os om vores tjenestebrugere, er blandt de overførte aktiver.</p>
                    </li>
                    <li>
                        <p><strong>Til andre formål</strong>: Vi kan bruge dine oplysninger til andre formål, såsom dataanalyse, identificering af brugstendenser, bestemmelse af effektiviteten af vores salgsfremmende kampagner og for at evaluere og forbedre vores tjeneste, produkter, tjenester, markedsføring og din oplevelse.</p>
                    </li>
                </ul>
                ...
                <h3>Dine databeskyttelsesrettigheder under GDPR</h3>
                <p>Hvis du er bosiddende i EU/EØS, har du visse databeskyttelsesrettigheder. Virksomheden sigter mod at tage rimelige skridt til at give dig mulighed for at rette, ændre, slette eller begrænse brugen af dine personlige data.</p>
                <p>Hvis du ønsker at blive informeret om, hvilke personlige data vi opbevarer om dig, og hvis du ønsker, at de fjernes fra vores systemer, bedes du kontakte os.</p>
                <p>Under visse omstændigheder har du følgende databeskyttelsesrettigheder:</p>
                <ul>
                    <li>
                        <p><strong>Retten til at få adgang til, opdatere eller slette de oplysninger, vi har om dig.</strong> Når det er muligt, kan du få adgang til, opdatere eller anmode om sletning af dine personlige data direkte inden for dine kontoinstillinger. Hvis du ikke er i stand til at udføre disse handlinger selv, bedes du kontakte os for at hjælpe dig.</p>
                    </li>
                    <li>
                        <p><strong>Retten til berigtigelse.</strong> Du har ret til at få dine oplysninger berigtiget, hvis disse oplysninger er unøjagtige eller ufuldstændige.</p>
                    </li>
                    <li>
                        <p><strong>Retten til at gøre indsigelse.</strong> Du har ret til at gøre indsigelse mod vores behandling af dine personlige data.</p>
                    </li>
                    <li>
                        <p><strong>Retten til begrænsning.</strong> Du har ret til at anmode om, at vi begrænser behandlingen af dine personlige data.</p>
                    </li>
                    <li>
                        <p><strong>Retten til dataportabilitet.</strong> Du har ret til at få udleveret en kopi af de oplysninger, vi har om dig, i et struktureret, maskinlæsbart og almindeligt anvendt format.</p>
                    </li>
                    <li>
                        <p><strong>Retten til at trække samtykke tilbage.</strong> Du har også ret til at trække dit samtykke tilbage når som helst, hvor virksomheden påberåber sig dit samtykke til at behandle dine personlige data.</p>
                    </li>
                </ul>
                <p>Bemærk venligst, at vi kan bede dig om at bekræfte din identitet, før vi besvarer sådanne anmodninger.</p>
                <p>Du har ret til at klage til en databeskyttelsesmyndighed om vores indsamling og brug af dine personlige data. For mere information, hvis du er i Det Europæiske Økonomiske Samarbejdsområde (EØS), bedes du kontakte din lokale databeskyttelsesmyndighed i EØS.</p>
                <h3>Dine databeskyttelsesrettigheder under CCPA</h3>
                <p>Denne del af privatlivspolitikken for californiske beboere supplerer de oplysninger, der er indeholdt i vores privatlivspolitik, og gælder udelukkende for besøgende, brugere og andre, der bor i staten Californien.</p>
                <p>Under CCPA har californiske forbrugere rettigheder vedrørende deres personlige data. Du har ret til at anmode om at få oplyst, hvilke kategorier af personlige data vi har indsamlet om dig, og hvilke kategorier af kilder, vi har brugt til at indsamle dataene fra. Du har ret til at anmode om sletning af dine personlige data, som vi har indsamlet om dig. Du har ret til at anmode om ikke at blive diskrimineret for at udøve nogen af dine rettigheder.</p>
                <p>For at udøve dine rettigheder under CCPA og hvis du er bosiddende i Californien, kan du kontakte os via de kontaktoplysninger, vi har angivet.</p>
                <p>Virksomheden vil ikke diskriminere dig for at udøve dine rettigheder under CCPA. Medmindre det er tilladt i henhold til CCPA, vil vi ikke:</p>
                <ul>
                    <li>Nægte dig varer eller tjenester</li>
                    <li>Opkræve dig forskellige priser eller takster for varer eller tjenester, herunder ved at give rabatter eller andre fordele, eller pålægge dig sanktioner</li>
                    <li>Give dig et andet niveau eller kvalitet af varer eller tjenester</li>
                    <li>Foreslå, at du kan modtage en anden pris eller takst for varer eller tjenester eller et andet niveau eller kvalitet af varer eller tjenester.</li>
                </ul>
                <p>Bemærk venligst, at vi kan bede dig om at bekræfte din identitet, før vi besvarer sådanne anmodninger.</p>
                <p>Visse rettigheder under CCPA er dog ikke absolutte og er underlagt undtagelser i henhold til gældende lovgivning.</p>
                <h4>Kontakt os</h4>
                <p>Hvis du har spørgsmål til denne privatlivspolitik, kan du kontakte os:</p>
                <ul>
                    <li>Via email: [din-email-adresse]</li>
                    <li>Via telefonnummer: [dit-telefonnummer]</li>
                </ul>
            </>
        )
        }