  ...
  useEffect(() => {
    if (user.language === 0) {
      ...
      setLabelsManageStock({
        ...
        sub_category_name: "sub_category_en", 
      ...
      setLabelsManageStock({
        ...
        measure: "Medida", 
        category: "Categoría",
        category_name: "category_es", 
        sub_category_name: "sub_category_es", 
        sub_category: "Sub-Categ.", 
      ...
      setLabelsManageStock({
        ...
        measure: "Måle", 
        category: "Kategori", 
        category_name: "category_dk", 
        sub_category_name: "sub_category_dk", 
      ...
      setLabelsManageStock({
        ...
        measure: "Misurare", 
        category: "Categoria",
        category_name: "category_it", 
        sub_category_name: "sub_category_it",  
